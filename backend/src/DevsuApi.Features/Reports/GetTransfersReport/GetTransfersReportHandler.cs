...
public sealed class GetTransfersReportHandler(IClientRepository clientRepository) : IRequestHandler<GetTransfersReportQuery, Result<IEnumerable<TransfersReportResponse>>>
{
